...
# Original fxirb script. Large portions have been extracted into guirb.rb, and
# this will eventually be rewritten as a hollow shell of its former self, once
# I get fxruby working properly on 1.9
# ----------------------------------------------------------------------------
